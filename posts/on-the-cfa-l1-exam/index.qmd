...
**I thought the exam was pretty straightforward** (my version of it, at least), just shy of being easy. There was only one question (out of 180) where I didn’t recall seeing the related concept at all. (By my highlighter patterns, it was something I had read in the first few months of studying. I never made any notes for it or revisited it, though. So it truly was a recall failure.) **There were no surprises.**
...
I guessed on about 10-15 questions per session (there are two sessions), with slightly more guessing in the second session. The second session included more of the content I hadn’t reached. So, why hadn’t I finished the entire curriculum? There’s a good reason.

**While studying for the CFA exam, I studied for and passed two out of three levels of an entirely different finance and trading-related credential**—the [Chartered Market Technician (CMT) program](https://cmtassociation.org/). This program is not as well known, but just as rigorous and intense, with hundreds of pages of deeply technical reading on markets and [technical analysis](https://en.wikipedia.org/wiki/Technical_analysis) per level (there are 3). Studying for both at the same time worked for a bit as there is some overlap in the [content between the two exams](https://cmtassociation.org/wp-content/uploads/2025/02/2025-Detailed-CMT-Program-Guide.pdf). 

I was scheduled to take the third and final CMT exam in June/July, but pushed it to December 2026 to prioritze CFA. Funny enough, **I was able to use some of my learnings from the CMT on the CFA and vice versa.** (There is a reason I had all of this stuff overlapping that perhaps I will explain later.)

![CMT is amazing for learning one way to watch the pulse of markets. 5-min NYSE TICK chart from TradingView.](nyse-tick.png)


I had a moment of frustration because there were definitely questions from content I didn’t reach (or hadn’t spent as much time on as others). And unfortunately, some of that content was from a more heavily-weighted topic on the exam. But, again, I tried to intelligently guess and move on. It's useless to spend any real time on those kind of questions as that would steal time from questions I could answer. This was especially true if those questions involved any kind of calculation and needed to be worked more carefully and/or double-checked.
...
(Results come late September, early October. We shall see!)

**Update:** Got the results back this morning, September 24th, 2026. **PASSED.** ([43% pass rate out of 28,145 candidates](https://www.cfainstitute.org/about/press-room/2026/cfa-institute-reports-results-cfa-program-level-i-testing-august-2026).)
